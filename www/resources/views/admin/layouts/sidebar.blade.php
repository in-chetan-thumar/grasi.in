...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ route('root') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ asset('assets/frontend/images/logo.svg') }}" alt="" height="30">
            </span>
            <span class="logo-lg">
                <img src="{{ asset('assets/frontend/images/logo.svg') }}" alt="" height="30">
            </span>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('dealers.index') }}">
                        <i class="fas fa-handshake"></i> <span>Dealers</span>
                    </a>
                </li>
