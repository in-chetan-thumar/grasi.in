    ...
    <div class="site-main">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <div class="main_logo">
                    <a href="{{ route('enquiry.index') }}"><img
                            src="{{ asset('assets/images/landing_image/llumar_india_logo.webp') }}"
                            alt="" /></a>
                </div>
                <div class="header_info">
                    <ul>
                        <li>
                            <a target="_blank" href="https://wa.me/+917400480852?text="><svg viewBox="0 0 20 20"
                        ...
                        <li>
                            <a href="tel:+917400480852"><svg viewBox="0 0 16 23" xmlns="http://www.w3.org/2000/svg">
                                    <path
        ...
        <footer>
            <div class="container">
                ...
                <p>
                    Handcrafted with ❤ by
                    <a href="https://www.buzzmakers.in/" target="_blank">Buzz Makers.</a>
                </p>
            </div>
        </footer>

        <button type="button" class="btn_back_top" id="btn-back-to-top">
