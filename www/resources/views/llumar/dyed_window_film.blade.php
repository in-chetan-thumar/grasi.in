...
@section('content')
    ...
    <section class="hero-section hero-section-dyed responsive-mobile">
        ...
        <div>
            <img src="{{ asset('assets/llumar/images/dyed_window_film/web page 1.png')}}" class="w-100" alt="">
        </div>
    </section>
    ...
    <section class="section-ppf bg-dark-gray">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1> Dyed Window Films</h1>
                    <div class="title-divider">
                        <img src="{{ asset('assets/llumar/images/dash.svg')}}" alt="">
                    </div>
                    <p> Enhance your vehicle’s appearance with Dyed Window Films, an affordable and integrated dye that
                        ensures heat rejection and enhanced privacy. With fade-resistant and anti-discolouration benefits,
                        it is available in 70% VLT and 50% VLT, designed to offer advanced sun protection and security. The
                        colour-stable Gold series includes Opal 70 and Opal 50, which offer excellent colour stability for
                        long-lasting colour fastness and zero fading. The Silver series, on the other hand, includes
                        deep-dyed products, Grey 70 and Grey 50, that feature high-performance resin adhesives, preventing
                        bubbles on the film.</p>
                </div>
                <div class="col-md-6">
                    <div class="ppf-image">
                        <img src="{{ asset('assets/llumar/images/dyed_window_film/web page 2.png')}}" class="w-100" alt="">
                        <img src="{{ asset('assets/llumar/images/dyed_window_film/web page 3.png')}}" class="film-img"
                            alt="">
                    </div>
                </div>
            </div>
    ...
    <section class="why-choose why-choose-dyed reveal">
        <div class="container">
            <div>
                ...
                <h2>LLumar Dyed Window Films</h2>
                <div class="title-divider">
                    <img src="{{ asset('assets/llumar/images/dash.svg')}}" alt="">
                </div>
            </div>
    ...
    <!-- features -->
    <section class="features-section features-section-dyed reveal">
        <div class="container">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item reveal">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    How long does LLumar Dyed Window Films last?
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    The LLumar Dyed Film is designed to retain its deep colour without fading, ensuring
                                    higher durability.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item reveal">
                            <h2 class="accordion-header" id="headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    Does dyed film block heat?
                                </button>
                            </h2>
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes, the darker the shade, the more heat rejection you’ll experience, leading to a
                                    cooler interior.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item reveal">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    No, it's best to wait 48-72 hours to allow the film to fully adhere before rolling down
                                    windows.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item reveal">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Click on the ‘Locate LLumar Dealer’ option on our website to find the nearest expert
                                    installer.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item reveal">
                            <h2 class="accordion-header" id="headingFive">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    Is LLumar Dyed Window Film scratch-resistant?
                                </button>
                            </h2>
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes, the film features a scratch-resistant coating that also extends its life.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item reveal">
                            <h2 class="accordion-header" id="headingSix">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    Will dyed window film interfere with my car’s electronics?
                                </button>
                            </h2>
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    No, the dyed film does not affect radio, GPS, or mobile signals.
                                </div>
                            </div>
                        </div>
                    </div>
