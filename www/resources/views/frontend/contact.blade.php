...
@section('content')
    ...
    <section class="p0 inner_page contact_page">
        ...
        <section class="inner_banner p0"
            style="background:url({{ asset('assets/frontend/images/contact_pagebg.webp') }});background-position: center;background-repeat: no-repeat;background-size: cover;">
            <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8">
                                <figcaption>
                                    ...
                                    <p>Have any question in mind or want to enquire? Please feel free to contact us through
                                        the form or the following details.</p>
                                </figcaption>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-12 col-lg-12 col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div class="submit_btn">
                                        ...
                                        {!! Form::submit('Send Message', [
                                            'class' => 'save primary-button btn btn-primary g-recaptcha',
                                            'id' => 'btnsubmit1',
