...
{{-- Our Story title  --}}
@section('title') Our Story @endsection
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-10 col-lg-10">
                    <div class="row">
                        <div class="col-10 col-lg-8 col-lg-8 col-lg-8 col-md-8 col-sm-8">
                            <figcaption>
        ...
        <div class="container">
            <div class="title_1">
                ...
                <div class="main_arrow"> 
                    <div class="swiper-button-prev swiper-button-prev-journey"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                         height="24" viewBox="0 0 24 24" fill="none"> <path d="M14.6 6L16 7.4L11.4 12L16 16.6L14.6 18L8.6 12L14.6 6Z" fill="white"/> </svg> </div>
                    <div class="swiper-button-next swiper-button-next-journey"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"> <rect width="24" height="24" rx="12" fill="#00A6C0"/> <path d="M9.4 18L8 16.6L12.6 12L8 7.4L9.4 6L15.4 12L9.4 18Z" fill="white"/> </svg> </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-lg-10">
                    <div class="row g-4 justify-content-center">
                        <div class="col-lg-4 col-lg-4 col-lg-4 col-md-4 col-sm-6">
    ...
    <section class="mission">
        <div class="container">
            <div class="mission_row">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-lg-8 col-lg-8 col-lg-8 col-md-9">
                    ...
                    <div class="col-lg-10 col-lg-10 col-lg-10 col-md-11">
