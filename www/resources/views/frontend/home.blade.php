        ...
        <div class="swiper_main_slide">
            <div class="swiper-container-banner">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img srcset="{{ asset('assets/frontend/images/banner2.webp') }}"
                            src="{{ asset('assets/frontend/images/banner2.webp') }}" alt="image" />
                        <div class="banner_figcaption">
                            <div class="container">
                                <figcaption>
                    ...
                    <div class="swiper-slide">
                        <img srcset="{{ asset('assets/frontend/images/banner3.webp') }}"
                            src="{{ asset('assets/frontend/images/banner3.webp') }}" alt="image" />
                        <div class="banner_figcaption">
                            <div class="container">
                                <figcaption>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <figure class="solution_box hover_box">
                                <a href="{{ route('llumar.window.films.index') }}" target="_blank" class="hover_img">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <figure class="solution_box hover_box">
                                <a href="{{ route('enquiry.index') }}" target="_blank" class="hover_img">
            ...
            <div class="video_icon">
                <svg viewBox="0 0 462.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                    <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" stroke="none">
                        <path
                            d="M175 5105 c-60 -22 -110 -68 -139 -127 l-26 -52 0 -2366 0 -2366 26 -52 c31 -63 81 -106 148 -128 72 -24 141 -14 229 34 40 21 974 546 2077 1166 1250 703 2019 1142 2043 1164 54 53 77 106 77 182 0 76 -23 129 -77 182 -24 22 -793 461 -2043 1164 -1103 620 -2038 1145 -2078 1167 -86 46 -168 57 -237 32z">
                        </path>
                    </g>
                </svg>
            </div>
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    <div class="col-12 col-xxl-4 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="count_up animate is_done in_view">
                            <p class="number">
                                <span class="value" data-seperator="" data-decimal="0"
                                    data-count="20000000">200,00,000</span>
                                <span class="suffix">+</span>
                            </p>
                                ...
                                <div class="why_grass">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="whygrass_icn">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                                    ...
                                                    <path
                                                        d="M14.0007 11.6673C16.578 11.6673 18.6673 9.57798 18.6673 7.00065C18.6673 4.42332 16.578 2.33398 14.0007 2.33398C11.4233 2.33398 9.33398 4.42332 9.33398 7.00065C9.33398 9.57798 11.4233 11.6673 14.0007 11.6673Z"
                                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="M24.5 25.668C24.5 19.8691 19.7989 15.168 14 15.168C8.20108 15.168 3.5 19.8691 3.5 25.668"
                                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="M13.9993 25.668L16.3327 22.7513L13.9993 15.168L11.666 22.7513L13.9993 25.668Z"
                                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </svg>
                                            </div>
                                            <div class="whygrass_cnt">
                                                ...
                                                <p>Backed by over 20 years of experience, we come with unparalleled
                                                    expertise in the market.</p>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            <div class="whygrass_icn">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                                    viewBox="0 0 28 28" fill="none">
                                                    <path
                                                        d="M17.5 5.83398C17.5 4.90573 17.1313 4.01549 16.4749 3.35911C15.8185 2.70273 14.9283 2.33398 14 2.33398C13.0717 2.33398 12.1815 2.70273 11.5251 3.35911C10.8687 4.01549 10.5 4.90573 10.5 5.83398V14.0007C10.5 14.9289 10.8687 15.8191 11.5251 16.4755C12.1815 17.1319 13.0717 17.5007 14 17.5007C14.9283 17.5007 15.8185 17.1319 16.4749 16.4755C17.1313 15.8191 17.5 14.9289 17.5 14.0007V5.83398Z"
                                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="M22.2496 10.7007C22.8971 10.0426 23.2584 9.15516 23.2546 8.23184C23.2509 7.30853 22.8824 6.42411 22.2295 5.77122C21.5766 5.11833 20.6922 4.74988 19.7689 4.74612C18.8456 4.74236 17.9582 5.1036 17.3 5.75115L11.525 11.5261C11.2 11.8512 10.9422 12.237 10.7663 12.6617C10.5905 13.0864 10.5 13.5415 10.5 14.0011C10.5001 14.9294 10.8689 15.8197 11.5253 16.476C12.1817 17.1324 13.072 17.5011 14.0003 17.501C14.9286 17.501 15.8188 17.1322 16.4752 16.4757L22.2502 10.7007H22.2496Z"
                                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="
z"
                                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                    <path
                                                        d="M10.7007 5.75115C10.0426 5.1036 9.15516 4.74236 8.23184 4.74612C7.30853 4.74988 6.42411 5.11833 5.77122 5.77122C5.11833 6.42411 4.74988 7.30853 4.74612 8.23184C4.74236 9.15516 5.1036 10.0426 5.75115 10.7007L11.5261 16.4757C11.8502 16.8051 12.2362 17.067 12.662 17.2464C13.0877 17.4258 13.5448 17.5192 14.0068 17.5211C14.4689 17.5229 14.9267 17.4333 15.3539 17.2574C15.7811 17.0815 16.1693 16.8227 16.496 16.496C16.8227 16.1693 17.0815 15.7811 17.2574 15.3539C17.4333 14.9267 17.5229 14.4689 17.5211 14.0068C17.5192 13.5448 17.4258 13.0877 17.2464 12.662C17.067 12.2362 16.8051 11.8502 16.4757 11.5261L10.7007 5.75115Z"
                                                        stroke="white" stroke-width="2" stroke-linecap="round"
                                                        stroke-linejoin="round" />
                                                </svg>
                                            </div>
                                            <div class="whygrass_cnt">
                                                ...
                                                <p>Armed with a solution for every request, we also come equipped with
                                                    resources to fabricate one to match novel needs.</p>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <div class="whygrass_cnt">
                                                <h2>Excellence</h2>
                                                <p>Curated with state-of-the-art technology, our offerings are rightfully
                                                    discerned as the best in business.</p>
                                            </div>
                                        </li>
        ...
        <div class="container">
            ...
            <div class="slider">
                <div class="slide-track">
                    ...
                    <div class="slide"><img src="{{ asset('assets/frontend/images/brands/brand-logos/Google-G.png') }}"
                            alt="image"></div>
                    <div class="slide"><img src="{{ asset('assets/frontend/images/brands/brand-logos/RBS.png') }}"
                            alt="image"></div>
                    <div class="slide"><img src="{{ asset('assets/frontend/images/brands/brand-logos/vodafone.png') }}"
                            alt="image"></div>
                    <div class="slide"><img src="{{ asset('assets/frontend/images/brands/brand-logos/DBS.png') }}"
                            alt="image"></div>
                    {{-- <div class="slide"><img src="{{ asset('assets/frontend/images/logo5.svg')}}" alt="image"></div> --}}
                </div>
            </div>
                            ...
                            <figure class="industries_box">
                                <div class="industries_icn">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36"
                                        ...
                                        <path
                                            d="M3.375 31.5H32.625M5.625 4.5V31.5M21.375 4.5V31.5M30.375 11.25V31.5M10.125 10.125H11.25M10.125 14.625H11.25M10.125 19.125H11.25M15.75 10.125H16.875M15.75 14.625H16.875M15.75 19.125H16.875M10.125 31.5V26.4375C10.125 25.506 10.881 24.75 11.8125 24.75H15.1875C16.119 24.75 16.875 25.506 16.875 26.4375V31.5M4.5 4.5H22.5M21.375 11.25H31.5M25.875 16.875H25.887V16.887H25.875V16.875ZM25.875 21.375H25.887V21.387H25.875V21.375ZM25.875 25.875H25.887V25.887H25.875V25.875Z"
                                            stroke="black" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round" />
                            ...
                            <figure class="industries_box">
                                <div class="industries_icn">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="37" height="36"
                                        viewBox="0 0 37 36" fill="none">
                                        <path
                                            d="M27.5762 3H9.57617C8.78052 3 8.01746 3.31607 7.45485 3.87868C6.89224 4.44129 6.57617 5.20435 6.57617 6V30C6.57617 30.7957 6.89224 31.5587 7.45485 32.1213C8.01746 32.6839 8.78052 33 9.57617 33H27.5762C28.3718 33 29.1349 32.6839 29.6975 32.1213C30.2601 31.5587 30.5762 30.7957 30.5762 30V6C30.5762 5.20435 30.2601 4.44129 29.6975 3.87868C29.1349 3.31607 28.3718 3 27.5762 3Z"
                                            stroke="black" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M14.0762 24L14.5982 23.64C16.7957 22.1205 20.3582 22.1205 22.5542 23.64L23.0762 24M12.5762 10.5H12.5912M24.5762 10.5H24.5912M18.5762 10.5H18.5912M18.5762 16.5H18.5912M24.5762 16.5H24.5912M12.5762 16.5H12.5912M15.5762 33V23.25M21.5762 23.25V33"
                                            stroke="black" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <rect x="27.5762" y="9" width="3" height="18"
                                            transform="rotate(90 27.5762 9)" fill="#00A6C0" />
                                    </svg>
                                </div>
                                <h2>Restaurants </h2>
                            </figure>
                            ...
                            <figure class="industries_box">
                                <div class="industries_icn">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="37" height="36"
                                        viewBox="0 0 37 36" fill="none">
                                        <path
                                            d="M6.57617 9L18.5762 3L30.5762 9M27.5762 15L33.5762 18V30C33.5762 30.7957 33.2601 31.5587 32.6975 32.1213C32.1349 32.6839 31.3718 33 30.5762 33H6.57617C5.78052 33 5.01746 32.6839 4.45485 32.1213C3.89224 31.5587 3.57617 30.7957 3.57617 30V18L9.57617 15"
                                            stroke="black" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M21.5762 33V27C21.5762 26.2044 21.2601 25.4413 20.6975 24.8787C20.1349 24.3161 19.3718 24 18.5762 24C17.7805 24 17.0175 24.3161 16.4549 24.8787C15.8922 25.4413 15.5762 26.2044 15.5762 27V33M27.5762 7.5V33M9.57617 7.5V33"
                                            stroke="black" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                                        <path
                                            d="M18.5762 16.5C20.233 16.5 21.5762 15.1569 21.5762 13.5C21.5762 11.8431 20.233 10.5 18.5762 10.5C16.9193 10.5 15.5762 11.8431 15.5762 13.5C15.5762 15.1569 16.9193 16.5 18.5762 16.5Z"
                                            stroke="black" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" />
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <video class="insta-video" controls="" id="reel2"
                            poster="{{ asset('assets/frontend/images/Reel_Covers/6.webp') }}">
                            <source src="{{ asset('assets/frontend/images/videos/Window_Film.mp4') }}" type="video/mp4">
                            <source src="{{ asset('assets/frontend/images/videos/Window_Film.mp4') }}" type="video/ogg">
                        </video>
                    ...
                    <div class="swiper-slide">
                        <video class="insta-video" controls="" id="reel3"
                            poster="{{ asset('assets/frontend/images/Reel_Covers/1.webp') }}">
                            <source src="{{ asset('assets/frontend/images/videos/Gras-i_Meet-The.mp4') }}"
                                type="video/mp4">
                            <source src="{{ asset('assets/frontend/images/videos/Gras-i_Meet-The.mp4') }}"
                                type="video/ogg">
                        </video>
                    ...
                    <div class="swiper-slide">
                        <video class="insta-video" controls="" id="reel4"
                            poster="{{ asset('assets/frontend/images/Reel_Covers/3.webp') }}">
                            <source src="{{ asset('assets/frontend/images/videos/Gras-i_was_delighted.mp4') }}"
                                type="video/mp4">
                            <source src="{{ asset('assets/frontend/images/videos/Gras-i_was_delighted.mp4') }}"
                                type="video/ogg">
                        </video>
                    ...
                    <div class="swiper-slide">
                        <video class="insta-video" controls="" id="reel5"
                            poster="{{ asset('assets/frontend/images/Reel_Covers/2.webp') }}">
                            <source src="{{ asset('assets/frontend/images/videos/The_Ferrari_296_GTB.mp4') }}"
                                type="video/mp4">
                            <source src="{{ asset('assets/frontend/images/videos/The_Ferrari_296_GTB.mp4') }}"
                                type="video/ogg">
                        </video>
