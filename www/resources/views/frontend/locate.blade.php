            ...
            <div class="container">
                ...
                <div class="row g-4 align-items-end">
                                ...
                                <div class="form-group input-box select-box" id="filterDropdown">
                                    ...
                                    <div class="relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" height="6"
                                            ...
                                            <path
                                                d="M5.75593 5.62713C5.35716 6.08759 4.64284 6.08759 4.24407 5.62713L1.23682 2.15465C0.675942 1.50701 1.136 0.5 1.99275 0.5L8.00725 0.5C8.864 0.5 9.32406 1.50701 8.76318 2.15465L5.75593 5.62713Z"
                                                fill="#000000"></path>
                                        </svg>
                                        <select name="state_id" id="state_id" class="form-control input">
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{ $state }}"
                                                    {{ request()->query('state_id') == $state ? 'selected' : '' }}>
                                                    {{ $state }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group input-box select-box">
                                    ...
                                    <div class="relative">
                                        ...
                                        {!! Form::select('city_id', isset($states) ? $cities : [], request()->query('city_id'), [
                    ...
                    <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-12 link">
                        ...
                        <a href="#" class="btn btn-primary red" data-bs-toggle="modal"
                            data-bs-target="#exampleModal">Become a Dealer</a>
                    </div>
                </div>
                {!! Form::close() !!}
                {{-- dealer form end  --}}
