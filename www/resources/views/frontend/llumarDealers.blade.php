        ...
        <div class="row g-4">
                    ...
                    <ul>
                        ...
                        <li class="details">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path
                                    d="M12.916 0.833984H6.24935C5.69681 0.833984 5.16691 1.05348 4.77621 1.44418C4.38551 1.83488 4.16602 2.36478 4.16602 2.91732V17.084C4.16602 17.6365 4.38551 18.1664 4.77621 18.5571C5.16691 18.9478 5.69681 19.1673 6.24935 19.1673H12.916C13.4685 19.1673 13.9985 18.9478 14.3892 18.5571C14.7799 18.1664 14.9993 17.6365 14.9993 17.084V2.91732C14.9993 2.36478 14.7799 1.83488 14.3892 1.44418C13.9985 1.05348 13.4685 0.833984 12.916 0.833984ZM9.58268 18.334C8.89102 18.334 8.33268 17.7757 8.33268 17.084C8.33268 16.3923 8.89102 15.834 9.58268 15.834C10.2743 15.834 10.8327 16.3923 10.8327 17.084C10.8327 17.7757 10.2743 18.334 9.58268 18.334ZM13.3327 15.0007H5.83268V3.33398H13.3327V15.0007Z"
                                    fill="black" />
                            </svg>
                        ...
                        @if (!empty($row->contact_number2))
                            <li class="details">
                                ...
                                <a href="tel:{{ $row->contact_number2 }}">
                                    {{ $row->contact_number2 }}
                                </a>
                                <button class="copy-button"> <img
                                        src="{{ asset('assets/frontend/images/copy.svg') }}" /></button>
                            </li>
                        @endif
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="dealers_map">
                    ...
                    <iframe src="{!! $row->url !!}" width="600" height="450" style="border:0;" allowfullscreen=""
                        loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

                    {{-- <iframe
                        src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d57765.99227337182!2d{{$row->longitude}}!3d{{$row->latitude}}!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1692266161871!5m2!1sen!2sin"
