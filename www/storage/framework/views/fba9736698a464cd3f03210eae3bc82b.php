                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <input type="hidden" name="id" value="<?php echo e($WhatsAppTemplate->id); ?>"
                                id="whatsapp_template_id">
                            <input type="hidden" name="template_type" value="<?php echo e($WhatsAppTemplate->template_type); ?>">
                            
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="mb-3">
                                    <div class="form-group">
                                        <?php echo e(Form::label('Template name')); ?><span class="required">*</span>
                                        <?php echo Form::text('template_name', $WhatsAppTemplate->template_name, [
                                            'class' => 'form-control',
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="mb-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::textarea('whatsapp_template_content', $WhatsAppTemplate->html_template, [
                                            'class' => 'form-control',
                                            'placeholder' => 'Content',
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\Laravel10ProjectSkeleton\www\resources\views/admin/templates/whatsapp_templates.blade.php ENDPATH**/ ?>