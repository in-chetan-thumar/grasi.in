                    ...
                    <tr>
                        <td class="header">
                            <a href="" style="display: inline-block;">
                                <img src="<?php echo e(asset('assets/images/logo' . DIRECTORY_SEPARATOR . config('constants.LOGO_FILE_NAME'))); ?>"
                                    alt="<?php echo e(config('constants.APP_NAME')); ?>" title="<?php echo e(config('constants.APP_NAME')); ?>">
                            </a>
                        </td>
                    </tr>
                                            ...
                                            <div class="nhsuk-width-container">
                                                <center>
                                                    <p class="nhsuk-footer__copyright">Powered by
                                                        <?php echo config('constants.DEVELOPED_BY'); ?>

                                                        version <?php echo e(config('constants.APP_VERSION')); ?>

                                                        <a class="nhsuk-footer__list-item-link" target="_blank"
                                                            href="https://caprihealthcare.co.uk/"
                                                            alt="<?php echo e(config('constants.APP_NAME')); ?>">
                                                        </a>
                                                    </p>
                                                </center>
                                            </div>
...
<?php /**PATH D:\OSPanel\domains\Laravel10ProjectSkeleton\www\resources\views/email/email_layout.blade.php ENDPATH**/ ?>