        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php echo Form::open(array('url' => route('roles.update',$role->id),'method'=>'PATCH','id'=>'role-form')); ?>
...
unset($__errorArgs, $__bag); ?>
                                                                ...
                                                                <div class="col-md-3 mt-2">
                                                                    <div class="nhsuk-checkboxes__item">
                                                                        <input class="nhsuk-checkboxes__input"
                                                                               ...
                                                                               aria-expanded="false"
                                                                            <?php echo e($role->hasPermissionTo($permisson_list['name'])?'checked':''); ?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <?php echo e(Form::button('Update role',['class'=>'btn btn-primary waves-effect btnSubmit waves-light'])); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\Laravel10ProjectSkeleton\www\resources\views/admin/role/edit_role.blade.php ENDPATH**/ ?>